...
def display_log_GCfg_readback( command_echo_param, log_enable, log_fname_param): # acr 2018-03-02
    ...
    print('\nTDCVcasN: %d'  %(GEMconf_classes_2018v3_0418.swap_order_N_bits(((L_array[1]>>16)&0xF),4)))
    print('\nTDCVcasP: %d'  %(GEMconf_classes_2018v3_0418.swap_order_N_bits(((L_array[1]>>8)&0x1F),5)))
    print('\nTDCVcasPHyst: %d'  %(GEMconf_classes_2018v3_0418.swap_order_N_bits(((L_array[1]>>0)&0x3F),6)))
    print('\nDiscFE_Ibias: %d'  %(GEMconf_classes_2018v3_0418.swap_order_N_bits(((L_array[2]>>24)&0x3F),6)))
    print('\nBiasFE_PpreN: %d' %(((L_array[2]>>16)&0x3F)) )
    print('\nAVcasp_global: %d'  %(GEMconf_classes_2018v3_0418.swap_order_N_bits(((L_array[2]>>8)&0x1F),5)))
    print('\nTDCcompVcas: %d'  %(GEMconf_classes_2018v3_0418.swap_order_N_bits(((L_array[2]>>0)&0xF),4)))
    print('\nTDCIref_cs: %d'  %(GEMconf_classes_2018v3_0418.swap_order_N_bits(((L_array[3]>>24)&0x1F),5)))
    print('\nDiscVcasN: %d'  %(GEMconf_classes_2018v3_0418.swap_order_N_bits(((L_array[3]>>16)&0xF),4)))
    print('\nIntegVb1: %d'  %(GEMconf_classes_2018v3_0418.swap_order_N_bits(((L_array[3]>>8)&0x3F),6)))
    print('\nBiasFE_A1: %d' %(((L_array[3]>>0)&0xF)) )
    print('\nVcasp_Vth: %d'  %(GEMconf_classes_2018v3_0418.swap_order_N_bits(((L_array[4]>>24)&0x3F),6)))
    print('\nTAC_I_LSB: %d' %(((L_array[4]>>16)&0x1F)) )
    print('\nTDCcompVbias: %d' %(((L_array[4]>>8)&0x1F)) )
    print('\nVref_Integ: %d'  %(GEMconf_classes_2018v3_0418.swap_order_N_bits(((L_array[4]>>0)&0x3F),6)))
    print('\nIBiasTPcal: %d'  %(GEMconf_classes_2018v3_0418.swap_order_N_bits(((L_array[5]>>24)&0x1F),5)))
    print('\nTP_Vcal: %d'  %(GEMconf_classes_2018v3_0418.swap_order_N_bits(((L_array[5]>>16)&0x1F),5)))
    print('\nShaperIbias: %d' %(((L_array[5]>>8)&0xF)) )
    print('\nIPostamp: %d'  %(GEMconf_classes_2018v3_0418.swap_order_N_bits(((L_array[5]>>0)&0x1F),5)))
    print('\nTP_Vcal_ref: %d'  %(GEMconf_classes_2018v3_0418.swap_order_N_bits(((L_array[6]>>24)&0x1F),5)))
    print('\nVref_integ_diff: %d'  %(GEMconf_classes_2018v3_0418.swap_order_N_bits(((L_array[6]>>16)&0x3F),6)))
...
gemroc_LV_XX = GEMconf_classes_2018v3_0418.gemroc_cmd_LV_settings(GEMROC_ID,'NONE',1,cfg_filename)
...
gemroc_DAQ_XX = GEMconf_classes_2018v3_0418.gemroc_cmd_DAQ_settings(GEMROC_ID,'NONE',0,1,0,cfg_filename)
...
g_inst = GEMconf_classes_2018v3_0418.g_reg_settings(GEMROC_ID,default_g_inst_settigs_filename)
...
c_inst = GEMconf_classes_2018v3_0418.ch_reg_settings(GEMROC_ID,default_ch_inst_settigs_filename)
