...
void WriteTgtGEMROC_TIGER_GCfgReg_fromfile(char*GCFGReg_setting_inst, unsigned int GEMROC_ID_param, unsigned int TIGER_ID_param,char*info)
{
...
void WriteTgtGEMROC_TIGER_ChCfgReg_fromfile (char*ChCFGReg_setting_inst,unsigned int  GEMROC_ID_param, 
          unsigned int TIGER_ID_param, unsigned int channel_ID_param,char*info)
{   int i;
...
//      sprintf(DEST_IP_ADDRESS,"192.168.1.%d",(GEMROC_ID+16)) ;
      ...
      DEST_PORT_NO = 58913;
   fd_cmd = fopen("vx_cmd_check.txt","w+");
   fw = fopen("my_vx_log.txt","w+");
...
{  
  ...
  if(cmd_para[0]>0)
  {
    ...
    if(strcmp(cmd_string,"GWdef")==0||strcmp(cmd_string,"GW")==0)
      if(cmd_para[0]==2)
      {
      WriteTgtGEMROC_TIGER_GCfgReg_fromfile("GW", GEMROC_ID, cmd_para[1],"WriteTgtGEMROC_TIGER_GCfgReg_fromfile in line 1770");
    ...
    if(strcmp(cmd_string,"CWdef")==0||strcmp(cmd_string,"CW")==0)
      if(cmd_para[0]==3)
      {
       WriteTgtGEMROC_TIGER_ChCfgReg_fromfile("c_inst", GEMROC_ID,cmd_para[1],cmd_para[2],"WriteTgtGEMROC_TIGER_ChCfgReg_fromfile in line 1782");
