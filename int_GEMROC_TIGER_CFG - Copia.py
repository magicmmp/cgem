...
##def SynchResetTgtGEMROC_TCAM_pattern(gemroc_DAQ_inst, GEMROC_ID_param, TCAM_pattern):
##    gemroc_DAQ_inst.set_target_GEMROC(GEMROC_ID_param)
##    gemroc_DAQ_inst.set_target_TCAM_ID(TIGER_ID_param, 0)
##    COMMAND_STRING = 'CMD_GEMROC_DAQ_TIGER_SYNCH_RST'
##    command_echo = send_GEMROC_DAQ_CMD (gemroc_DAQ_inst, GEMROC_ID_param, COMMAND_STRING)
##    return command_echo
...
##            os.system('cls')
            ...
            if not input_queue.empty():
                ...
                if ( (input_array[0] == 'quit') or (input_array[0] == 'q') or (input_array[0] == 'Quit') or (input_array[0] == 'Q') ):
                    ...
                    ParseSuccessful = 0
                if ( (input_array[0] == 'PEW') or (input_array[0] == 'P') ):
                    ...
                    ParseSuccessful = 0
                if ( (input_array[0] == 'IVT') or (input_array[0] == 'I') ) :
                ...
                if (input_array[0] == 'GRST'):
                    ...
                    ParseSuccessful = 0
                if ( (input_array[0] == 'GWdef') or (input_array[0] == 'GW') ):
                    if (len(input_array) == 2):
                    ...
                    ParseSuccessful = 0
                if ((input_array[0] == 'GRd') or (input_array[0] == 'GR')):
                    if (len(input_array) == 2):
                        command_reply = ReadTgtGEMROC_TIGER_GCfgReg( g_inst, GEMROC_ID, int(input_array[1]) )
                        print '\nGRd command_reply: %s' %binascii.b2a_hex(command_reply)
                    ...
                    ParseSuccessful = 0
                if ( (input_array[0] == 'CWdef') or (input_array[0] == 'CW') ):
                    ...
                    ParseSuccessful = 0
                if ((input_array[0] == 'CRd') or (input_array[0] == 'CR')):
                    if (len(input_array) == 3):
                    ...
                    ParseSuccessful = 0
                if ( (input_array[0] == 'TPEW_ch') or (input_array[0] == 'TP') ):
                ...
                if (input_array[0] == 'DRst'):
                    ...
                    ParseSuccessful = 0
                if (input_array[0] == 'DSTART'):
                    if (len(input_array) == 2):
                        DAQ_set_and_TL_start(gemroc_DAQ_XX, GEMROC_ID, TargetTCAM, TCAM_Enable_pattern )
                        print '\nTo TCAM %d or ToALL_TCAM: %d on GEMROC %d: sent synchronous reset' %( TargetTCAM, To_ALL_TCAM_enable, GEMROC_ID )
                        time.sleep(20)
                        ParseSuccessful = 1
                    else:
