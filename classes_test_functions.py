...
def print_log_GReg_members( g_reg_setting_object, log_enable, log_fname):
    ...
    print('\nTDCVcasN: %d'  %(GEMconf_classes_2018v2.swap_order_N_bits(g_reg_setting_object.TDCVcasN,4)))
    print('\nTDCVcasP: %d'  %(GEMconf_classes_2018v2.swap_order_N_bits(g_reg_setting_object.TDCVcasP,5)))
    print('\nTDCVcasPHyst: %d'  %(GEMconf_classes_2018v2.swap_order_N_bits(g_reg_setting_object.TDCVcasPHyst,6)))
    print('\nDiscFE_Ibias: %d'  %(GEMconf_classes_2018v2.swap_order_N_bits(g_reg_setting_object.DiscFE_Ibias,6)))
    print('\nBiasFE_PpreN: %d' %g_reg_setting_object.BiasFE_PpreN)
    print('\nAVcasp_global: %d'  %(GEMconf_classes_2018v2.swap_order_N_bits(g_reg_setting_object.AVcasp_global,5)))
    print('\nTDCcompVcas: %d'  %(GEMconf_classes_2018v2.swap_order_N_bits(g_reg_setting_object.TDCcompVcas,4)))
    print('\nTDCIref_cs: %d'  %(GEMconf_classes_2018v2.swap_order_N_bits(g_reg_setting_object.TDCIref_cs,5)))
    print('\nDiscVcasN: %d'  %(GEMconf_classes_2018v2.swap_order_N_bits(g_reg_setting_object.DiscVcasN,4)))
    print('\nIntegVb1: %d'  %(GEMconf_classes_2018v2.swap_order_N_bits(g_reg_setting_object.IntegVb1,6)))
    print('\nBiasFE_A1: %d' %g_reg_setting_object.BiasFE_A1)
    print('\nVcasp_Vth: %d'  %(GEMconf_classes_2018v2.swap_order_N_bits(g_reg_setting_object.Vcasp_Vth,6)))
    print('\nTAC_I_LSB: %d' %g_reg_setting_object.TAC_I_LSB)
    print('\nTDCcompVbias: %d' %g_reg_setting_object.TDCcompVbias)
    print('\nVref_Integ: %d'  %(GEMconf_classes_2018v2.swap_order_N_bits(g_reg_setting_object.Vref_Integ,6)))
    print('\nIBiasTPcal: %d'  %(GEMconf_classes_2018v2.swap_order_N_bits(g_reg_setting_object.IBiasTPcal,5)))
    print('\nTP_Vcal: %d'  %(GEMconf_classes_2018v2.swap_order_N_bits(g_reg_setting_object.TP_Vcal,5)))
    print('\nShaperIbias: %d' %g_reg_setting_object.ShaperIbias)
    print('\nIPostamp: %d'  %(GEMconf_classes_2018v2.swap_order_N_bits(g_reg_setting_object.IPostamp,5)))
    print('\nTP_Vcal_ref: %d'  %(GEMconf_classes_2018v2.swap_order_N_bits(g_reg_setting_object.TP_Vcal_ref,5)))
    print('\nVref_integ_diff: %d'  %(GEMconf_classes_2018v2.swap_order_N_bits(g_reg_setting_object.Vref_integ_diff,6)))
...
##g_inst = GEMconf_classes_2018.g_reg_settings(30,"default_g_cfg_2018_all_big_endian.txt")
...
##ch_reg_inst = GEMconf_classes_2018.ch_reg_settings(30,"default_ch_cfg_2018_all_big_endian.txt")
